                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($responsable as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombre }}</td><td>{{ $item->ci }}</td>
                                        <td><img src="{{ asset('storage').'/'.$item->foto }}" alt="" class="d-block rounded-circle" style="width: 40px; height: 40px;"></td>
                                        <td class="float-right">
                                            <a href="{{ url('/admin/responsable/' . $item->id) }}" title="View Responsable"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Mostrar</button></a>
                                            <a href="{{ url('/admin/responsable/' . $item->id . '/edit') }}" title="Edit Responsable"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modificar</button></a>
